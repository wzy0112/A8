...
def visualize_network_heatmaps():
    ...
    edge_output_file = os.path.join(project_root, "heat_edges", "a8_edge_output_od.xml")

    results_dir = os.path.join(project_root, "heat_edges")
    os.makedirs(results_dir, exist_ok=True)

    output_speed = os.path.join(results_dir, "network_speed_heatmap_od.png")
    output_flow = os.path.join(results_dir, "network_flow_heatmap_od.png")
    output_density = os.path.join(results_dir, "network_density_heatmap_od.png")
    output_vc = os.path.join(results_dir, "network_vc_heatmap_od.png")
