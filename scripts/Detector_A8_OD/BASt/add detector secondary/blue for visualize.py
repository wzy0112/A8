...
def run_sumo_gui():
    ...
    detector_additional_file = os.path.join(project_root, "detectors", "a8_detectors_secondary.add.xml")
    detector_poi_file = os.path.join(project_root, "detectors", "a8_detector_pois_secondary.add.xml")
