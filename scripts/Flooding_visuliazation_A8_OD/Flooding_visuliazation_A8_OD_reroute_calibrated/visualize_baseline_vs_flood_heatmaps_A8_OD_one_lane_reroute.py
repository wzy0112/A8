...
def main():
    ...
    flood_edge_file = os.path.join(project_root, "heat_edges", "a8_lane_close_edge_output_od_reroute.xml")

    results_dir = os.path.join(project_root, "heat_edges")
    os.makedirs(results_dir, exist_ok=True)

    output_speed = os.path.join(results_dir, "diff_speed_drop_map_od_one_lane_reroute.png")
    output_flow = os.path.join(results_dir, "diff_flow_change_map_od_one_lane_reroute.png")
    output_density = os.path.join(results_dir, "diff_density_increase_map_od_one_lane_reroute.png")
    output_vc = os.path.join(results_dir, "diff_vc_increase_map_od_one_lane_reroute.png")
    output_csv = os.path.join(results_dir, "baseline_vs_flood_diff_od_one_lane_reroute.csv")
