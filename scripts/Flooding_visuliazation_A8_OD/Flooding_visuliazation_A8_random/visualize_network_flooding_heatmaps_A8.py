...
def plot_network_heatmap(edge_geom, metric_df, title, colorbar_label, output_file):
...
def visualize_flooding_network_heatmaps():
    project_root = r"D:\SUMO_A9_Project"

    net_file = os.path.join(project_root, "sumo", "a8_corridor.net.xml")
    edge_output_file = os.path.join(project_root, "heat_edges", "a8_flood_edge_output.xml")

    results_dir = os.path.join(project_root, "heat_edges")
    os.makedirs(results_dir, exist_ok=True)

    output_speed = os.path.join(results_dir, "flood_network_speed_heatmap.png")
    output_flow = os.path.join(results_dir, "flood_network_flow_heatmap.png")
    output_density = os.path.join(results_dir, "flood_network_density_heatmap.png")
    ...
    print("=====================================")
    print("Loading flooding edge data")
    ...
    if df.empty:
        print("[ERROR] No flooding edge data found.")
        return
    ...
    plot_network_heatmap(
        edge_geom=edge_geom,
        metric_df=speed_df,
        title="Flooding Scenario: Mean Speed Heatmap",
    ...
    plot_network_heatmap(
        edge_geom=edge_geom,
        metric_df=flow_df,
        title="Flooding Scenario: Mean Flow Heatmap",
    ...
    plot_network_heatmap(
        ...
        title="Flooding Scenario: Mean Density Heatmap",
        colorbar_label="Density (veh/km)",
        output_file=output_density
    )

    print("=====================================")
    print("[SUCCESS] Flooding network heatmaps completed.")
    print(f"Results folder: {results_dir}")
    print("=====================================")


if __name__ == "__main__":
    visualize_flooding_network_heatmaps()