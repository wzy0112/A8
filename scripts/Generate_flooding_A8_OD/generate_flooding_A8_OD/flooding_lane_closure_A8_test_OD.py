...
def run_lane_closure_simulation():
    ...
    edge_data_additional_file = os.path.join(results_dir, "a8_lane_close_edge_data_od.add.xml")
    edge_output_file = os.path.join(results_dir, "a8_lane_close_edge_output_od.xml")
