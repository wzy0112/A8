...
def run_flooding_simulation():
    ...
    edge_data_additional_file = os.path.join(results_dir, "a8_flood_edge_data_od.add.xml")
    edge_output_file = os.path.join(results_dir, "a8_flood_edge_output_od.xml")
