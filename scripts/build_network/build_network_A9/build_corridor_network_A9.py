...
FULL_NET_FILE = os.path.join(SUMO_DIR, "a9_neufahrn_allershausen.net.xml")
KEEP_EDGES_FILE = os.path.join(SUMO_DIR, "keep_edges_A9.txt")
CORRIDOR_NET_FILE = os.path.join(SUMO_DIR, "a9_corridor.net.xml")
