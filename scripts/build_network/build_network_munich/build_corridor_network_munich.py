...
FULL_NET_FILE = os.path.join(SUMO_DIR, "munich.net.xml")
KEEP_EDGES_FILE = os.path.join(SUMO_DIR, "keep_edges_munich.txt")
CORRIDOR_NET_FILE = os.path.join(SUMO_DIR, "munich_corridor.net.xml")
